package org.eclipse.leshan.client.master;
...
public class LeshanClientMaster {

    private static final Logger LOG = LoggerFactory.getLogger(LeshanClientMaster.class);

    private final static String[] modelPaths = new String[] { "4404.xml" };

    private static final int OBJECT_ID_WEIGHT_SENSOR = 4404;
    private final static String DEFAULT_ENDPOINT = "LeshanClientMaster";
    private final static String USAGE = "java -jar leshan-client-master.jar [OPTION]\n\n";
    ...
    public static void createAndStartClient(String endpoint, String localAddress, int localPort, boolean needBootstrap,
        ...
        initializer.setInstancesForObject(OBJECT_ID_WEIGHT_SENSOR, new RandomLoadSensor());
        List<LwM2mObjectEnabler> enablers = initializer.create(SECURITY, SERVER, DEVICE, LOCATION,
                OBJECT_ID_WEIGHT_SENSOR);
